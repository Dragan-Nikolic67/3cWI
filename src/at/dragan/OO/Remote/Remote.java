...
public class Remote {
    ...
    public void getON() {
        if (this.getBatteries().get(0).getChargingStatus() || this.getBatteries().get(1).getChargingStatus()) {
            ...
            int Power;
            int Power1;
            Power = getBatteries().get(0).getPower() - 15;
    ...
    public void getStatus() {
        ...
        int Mittelwert;
        Mittelwert = (getBatteries().get(0).getPower() + getBatteries().get(1).getPower()) / 2;
        System.out.println("Hier ist der Mittelwert: " + Mittelwert);
